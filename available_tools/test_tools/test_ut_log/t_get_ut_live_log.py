...
DEFAULT_GNSS_CAPTURE_LOG_PATH = str(WSL_PERSISTENT_TEMP_PATH / "live_logs" / "gnss_57.log")
DEFAULT_INS_CAPTURE_LOG_PATH = str(WSL_PERSISTENT_TEMP_PATH / "live_logs" / "ins_monitor_57.log")
