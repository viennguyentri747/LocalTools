...
def run_motion_detection_elog_test(elog_paths: Sequence[str | Path], patterns: Sequence[str], require_all_patterns: bool = False) -> Dict[str, List[str]]:
...
def main(argv: Optional[Sequence[str]] = None) -> None:
    ...
    run_motion_detection_elog_test(elog_paths=elog_paths, patterns=patterns, require_all_patterns=False)
