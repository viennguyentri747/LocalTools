...
IESA_THIRD_PARTY_APPS_REPO_NAME = "third_party_apps"
IESA_ALL_COMPONENT_REPO_NAMES: List[str] = [IESA_TISDK_TOOLS_REPO_NAME, IESA_INTELLIAN_PKG_REPO_NAME,
                                            IESA_INSENSE_SDK_REPO_NAME, IESA_ADC_LIB_REPO_NAME, IESA_SPIBEAM_REPO_NAME, IESA_UPGRADE_REPO_NAME, IESA_THIRD_PARTY_APPS_REPO_NAME]
...
ACU_CACHE_UPGRADE_LOG_FILE= f"{ACU_DOWNLOAD_DIR}/upgrade_log.txt"
...
UT_77 = f"{SSM_NORMAL_IP_PREFIX}.77"
UT_56 = f"{SSM_NORMAL_IP_PREFIX}.56"
...
ARG_NOTE_REL_PATHS_TO_ADD_LINK = f"{ARGUMENT_LONG_PREFIX}paths_to_link_from"
...
BRANCH_AERO_MASTER = "aero_master"
BRANCH_MASTER = "master"
OW_MAIN_BRANCHES = [BRANCH_MANPACK_MASTER, BRANCH_MASTER, BRANCH_AERO_MASTER]
...
ARG_UPDATE_IMX_FW = f"{ARGUMENT_LONG_PREFIX}update_imx_fw"
ARG_UPDATE_GPX_FW = f"{ARGUMENT_LONG_PREFIX}update_gpx_fw"
...
REMOTE_CHECKSUM_FILE_MISSING = "__REMOTE_FILE_MISSING__"
